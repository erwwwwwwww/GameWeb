# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-06-26 16:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avater', models.ImageField(default='users/defaultAvater.jpg', upload_to='users', verbose_name='用户头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text='邮件', max_length=254, null=True, verbose_name='邮件')),
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articleComments', to='article.Articles')),
            ],
            options={
                'verbose_name': '用户评论',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backImage', models.ImageField(default='', upload_to='gameimage', verbose_name='游戏背景图')),
